...
namespace TetrisReturn
{
    public partial class GameOver : Form
    {
        ...
        public GameOver(MainForm mainForm)
        {
            InitializeComponent();
        ...
        private void imageButton1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (mainForm.Sound)
                mainForm.SoundControl.playSoundClick();
            mainForm.newGame();
            disAppear();
            this.Close();
        ...
        private void GameOver_Load(object sender, EventArgs e)
        {
            ...
            showInformation1.ImgBack = Constants.theme.GameOver;
            imageButton1.Image = Constants.theme.Button;
            imageButton2.Image = Constants.theme.Button;

            showInformation1.STitle = Constants.language.overConfirm;
        ...
        {
            e.Graphics.DrawImage(Constants.theme.GameOver, 0, 0);
        }
